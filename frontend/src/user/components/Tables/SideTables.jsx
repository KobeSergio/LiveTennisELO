              ...
              <div className="card rounded-3">
                <div className="card-body">
                  ...
                  <span className="card-text">
                    ...
                    is based on their best 16 results during a calendar year.
                    The points for a tournament will count towards a player’s
                  ...
                  <span className="card-text">
                    ...
                    should increase or decrease. There are two main variables
                    that are taken into account: How many matches are already in
                    the system (that is, how much confidence we have in the
                    pre-match rating), and the quality of the opponent.
                  </span>
                </div>
              </div>
            </div>

                    ...
                    <main className="col">
                        <div className='row gx-4 mb-3'>
                            <div className='col-md me-2 shadow'>
                                <h1 className='fs-4'>Overall Rating</h1>
                            ...
                            <div className='col-md me-2 shadow'>
                                <h1 className='fs-4 clay-text'>Clay Rating</h1>
                                <h2 className='fs-5'>From: <span id="years">2014-2022</span></h2>
                                <div>
                        ...
                        <div className='row gx-4'>
                            <div className='col-md me-2 shadow'>
                                <h1 className='fs-4 hard-text'>Hard Rating</h1>
                                <h2 className='fs-5'>From: <span id="years">2014-2022</span></h2>
                                <div>
                            ...
                            <div className='col-md me-2 shadow'>
                                <h1 className='fs-4 grass-text'>Grass Rating</h1>
                                <h2 className='fs-5'>From: <span id="years">2014-2022</span></h2>
                                <div>

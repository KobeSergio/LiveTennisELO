                    ...
                    <div className="login-form">
                        ...
                        <form>
                            ...
                            <div className="input-group">
                                ...
                                <div className="input-group-prepend bg-transparent">
                                    <span className="input-group-text bg-transparent" id="login_input" >
                                        <img src={require('../img/id-icon.png')} className="input-group-prepend bg-transparent border-0 login_input_img"></img>
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="input-group">
                                ...
                                <div className="input-group-prepend bg-transparent">
                                    <span className="input-group-text bg-transparent" id="login_input">
                                        <img src={require('../img/pw-icon.png')} className="input-group-prepend bg-transparent border-0 login_input_img"></img>
                                    </span>
                                </div>
                            </div>

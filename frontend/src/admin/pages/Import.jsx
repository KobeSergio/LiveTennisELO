  ...
  return (
    <>
      ...
      <div className="pt-3">
        ...
        <p>
          Please check the table below for the error and try to check for system
          solutions, or try to fix them first in your CSV and reupload.
        </p>
      </div>
      {/* Table here */}
    </>
  ...
  return (
    <>
      ...
      <div className="pt-3">
        ...
        <p>
          In order for the system to recognize your JSON file, please follow the
          spreadsheet demo file attached below.
        </p>
      </div>
      ...
      <div className="py-1">
        ...
        <ul className="py-2">
          ...
          <li>
            You can make a copy of our sample spreadsheet and save as CSV and
            then use this tool to convert to JSON.
          </li>
        </ul>
        <div>
      ...
      <div className="py-4">
        ...
        <button
          type="button"
          className="ms-4 px-2 btn btn-green-transparent btn-sm"
          style={{
            fontSize: "16px",
            borderWidth: "2px",
            width: "200px",
